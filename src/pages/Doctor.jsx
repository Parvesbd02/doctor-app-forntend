      ...
      <div className="flex flex-col sm:flex-row items-start gap-4 mt-5">
        ...
        <div className={` flex-col gap-4 text-sm text-gray-600 ${showFilter ? 'flex' : 'hidden sm:flex'}`  }>
          ...
          <p
            ...
            className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${speciality === "Gastroenterologis" ? "bg-indigo-100 text-black" : ""}`}
          >
            Gastroenterologist
          </p>
        </div>

        <div className="w-full grid lg:md:grid-cols-5 md:grid-cols-3 sm:grid-cols-1 gap-4 pt-5 gap-y-6 px-3 sm:px-0">
